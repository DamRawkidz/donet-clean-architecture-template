...
namespace Persistence
{
    public class DBIniaializer
    {
        public static async Task SeedData(AppDbContext context)
        {
            ...
            context.Activitys.AddRange(activity);
